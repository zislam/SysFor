 ...
 */
public class SysFor extends AbstractClassifier {
    ...
    private ArrayList<GoodAttribute> getGoodAttributes(Instances dataset, float goodness) {
        ...
        for (int i = 0; i < dataset.numAttributes(); i++) {
            ...
            if (currentAttribute.isNominal()) {
                ...
                C45Split split = new C45Split(i, minRecLeaf, 0.0, false);
                try {
     ...
     * @author Michael J. Siers
     */
    private class SysForTree extends AbstractClassifier {
        ...
        private ArrayList<J48> c45Trees = new ArrayList<J48>();
        private int numClasses = -1;
    ...
    private class SysForLevelTwoTree extends AbstractClassifier {
